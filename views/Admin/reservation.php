  ...
  <div class="container-fluid">
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/a/account/dashboard">
                <span data-feather="layers"></span>
                Flights
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" href="/a/account/reservation">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="container">
          <div class="row justify-content-center justify-content-around mb-4" id="reservation">
