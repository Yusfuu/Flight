...
<body>
  ...
  <main style="height: 80vh;" class="container d-flex align-items-center justify-content-center">
    <h1 class="fw-light"> Sorry, this page isn't available.</h1>
  </main>
</body>
